...
public abstract class KtTypeProvider : KtAnalysisSessionComponent() {
    ...
    public abstract fun areCompatible(a: KtType, b: KtType): Boolean
}
...
public interface KtTypeProviderMixIn : KtAnalysisSessionMixIn {
    ...
    public fun KtType.isCompatibleWith(that: KtType): Boolean = analysisSession.typeProvider.areCompatible(this, that)
}
